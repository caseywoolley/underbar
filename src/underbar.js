(function() {
  ...
  _.extend = function(obj) {
      return _.reduce(arguments, function(newObj, argObj){
        _.each(argObj, function(prop, key){
          newObj[key] = argObj[key];
        });
        return newObj;
      }, obj);
  };
  ...
  _.defaults = function(obj) {
    return _.reduce(arguments, function(newObj, argObj){
      _.each(argObj, function(prop, key){
        if (newObj[key] === undefined) { newObj[key] = argObj[key] };
      });
      return newObj;
    }, obj);
  };
  ...
  _.zip = function() {
    ...
    var sorted = _.sortBy(args, 'length');
    var longest = sorted[sorted.length - 1].length;
    var zipped = [];
  ...
  _.intersection = function() {
    ...
    _.each(repeats, function(value, key){
